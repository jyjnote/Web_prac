...
public class PythonScriptService {
    ...
    public String runPythonScript() {
        // 파이썬 스크립트의 정확한 경로
        String scriptPath = "C:\\Users\\jaeyeon\\Downloads\\PicketBackend\\PicketBackend-jiwoong\\src\\script\\test.py";

        // 파이썬 실행 파일의 경로 (아나콘다 가상 환경 내부)
        String pythonExecutablePath = "C:\\Users\\jaeyeon\\anaconda3\\envs\\transformers_env\\python.exe";
